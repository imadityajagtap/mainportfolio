...
export default function NewExperiencePage() {
  ...
  const onSubmit = async (data: ExperienceFormData) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Failed to create experience: ${getApiErrorMessage(jsonData, response.statusText)}`);
      }
    } catch (error) {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {/* Header */}
      <h1 className="text-3xl font-serif font-bold text-foreground mb-8">Add new experience</h1>
